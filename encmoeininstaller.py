...
def install():
    ...
    command1 = "sudo apt update -y && sudo apt full-upgrade && git clone {}".format(panel_and_encryption)
    command2 = "sudo chmod +x x-ui-with-moein-encryption-protocol/x-ui.sh && sudo ./x-ui-with-moein-encryption-protocol/x-ui.sh"
